module github.com/hoysics/geektime-basic-go
...
require (
	...
	github.com/aliyun/alibaba-cloud-sdk-go v1.62.698
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.883
